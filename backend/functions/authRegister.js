...
async function authRegister(email, phone_no, username, password) {
  try {
    ...
    let q = "INSERT INTO users (email, phone_no, username, password) VALUES ($1, $2, $3, $4) RETURNING *";
    const registered = await pool.query(q, [email, phone_no, username, encrypted]);
